...
@synthesize updating=updating_, appearEfect=appearEfect_, url=url_, indicator=indicator_, useCache = useCache_, error=error_, operation=operation_, useThumbnails=useThumbnails_;
